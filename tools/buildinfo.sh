...
[ ! -z "$PRODUCT_BRAND" ] && \
  ...
  echo "ro.product.brand=$PRODUCT_MANUFACTURER"
echo "ro.product.name=$PRODUCT_NAME"
echo "ro.product.board=$TARGET_BOOTLOADER_BOARD_NAME"
[ ! -z "$PRODUCT_MANUFACTURER" ] && \
  echo "ro.product.manufacturer=$PRODUCT_MANUFACTURER" || \
  echo "ro.product.manufacturer=$PRODUCT_BRAND"
if [ -z "$PRODUCT_VENDOR" ]; then
  [ ! -z "$PRODUCT_MANUFACTURER" ] && \
    echo "ro.product.vendor=$PRODUCT_MANUFACTURER" || \
    echo "ro.product.vendor=$PRODUCT_BRAND"
else
  echo "ro.product.vendor=$PRODUCT_VENDOR"
fi
...
echo "ro.alliance.device=$ALLIANCE_DEVICE"
